...
class WordController extends Controller
{
    public function descargarMultas($id){
		...
		$multa = new \PhpOffice\PhpWord\PhpWord();
    	...
    	$datos_encabezado->addCell(5500)->addText("AYUNTAMIENTO DE BENITO ".$inspeccion->folio." JUÁREZ QUINTANA ROO <w:br/>TESORERÍA MUNICIPAL <w:br/>DIRECCIÓN DE FISCALIZACIÓN
    		 <w:br/><w:br/>EXPEDIENTE: <w:t><w:b/>hola</w:t> <w:br/> <w:br/>ASUNTO: RESOLUCIÓN ADMINISTRATIVA<w:br/><w:br/>Cancún, Quintana Roo a ".strftime( "%Y-%m-%d-%H-%M-%S")."");
