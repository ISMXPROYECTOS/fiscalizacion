				...
				success: function (response) {
					if (response.code == 200) {
						...
						if (response.FormaValorada.tipo_inspeccion.clave == 'OIF') {
							$('#descargas').append(
								"<a target='_blank' href='"+url+'/pdf/descargar-pdf-inspecciones/'+id+"' class='btn btn-primary btn-lg btn-primary-custom' role='button'>Formato Común</a>" +
								"&nbsp;" +
								"<a target='_blank' href='"+url+'/pdf/descargar-pdf-inspecciones-complejas/'+id+"' class='btn btn-primary btn-lg btn-primary-custom' role='button'>Formato Complejo</a>" +
								"&nbsp;" +
								"<a target='_blank' href='"+url+'/pdf/descargar-pdf-citatorios/'+id+"' class='btn btn-primary btn-lg btn-primary-custom' role='button'>Citatorios</a>" +
								"&nbsp;" +
								"<a target='_blank' href='"+url+'/pdf/descargar-pdf-clausuras/'+id+"' class='btn btn-primary btn-lg btn-primary-custom' role='button'>Clausuras</a>"
							);
						} else {
							$('#descargas').append(
								"<a target='_blank' href='"+ url + '/pdf/descargar-pdf-inspecciones/' + id +"' class='btn btn-primary btn-lg btn-primary-custom' role='button'>Formato Común</a>" +
