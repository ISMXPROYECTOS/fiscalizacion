...
<body>
	<img src="{{ asset('img/header-orden-inspeccion-est.jpg') }}" width="100%">
	<div class="container">
		<p class="oi-header-datos mbt-0 text-right">MUNICIPIO DE BENITO JUÁREZ</p>
		...
		<p class="oi-header-datos mbt-0 text-right" style="text-transform: uppercase;">CANCUN, QUINTANA ROO A @if($inspeccion->comercio == null) _______________________ @else {{ $fecha_hoy}} @endif </p>
		<br>
		...
		@if(count($inspectoresExtra) >= 1) 
			...
			@endforeach
		@endif
		</b>@endif quienes podrán actuar de manera conjunta o individualmente.</p>
