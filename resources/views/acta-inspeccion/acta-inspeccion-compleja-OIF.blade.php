	...
	<body>
		...
		<div>
			...
			@if($inspeccion->comercio == null)
				<p style="margin-bottom: 5px;margin-top: 10px;"><b>NOMBRE DEL CONTRIBUYENTE: </b>_________________________________________________________________________________________________________</p>
				<p style="margin-bottom: 5px;margin-top: 0;"><b>NOMBRE COMERCIAL DEL ESTABLECIMIENTO: </b>_____________________________________________________________________________________________</p>
				<p style="margin-bottom: 5px;margin-top: 0;"><b>DOMICILIO DEL ESTABLECIMIENTO: </b>_______________________________________________________________________________________________________</p>
				...
				<p style="margin-bottom: 5px;margin-top: 0;"><b>NÚMERO DE PADRÓN MUNICIPAL: </b>________________________________________________________________________________________________________</p>
			@else
				...
				<tr>
					...
					<td class="representante" style="width:60%;">
						<div style="padding:5px;border-style:solid;border-width:1px;">
							<p style="text-transform: uppercase;"><b>Firma: </b>_______________________________________________________________________________</p>
							<p style="text-transform: uppercase;"><b>Nombre: </b>____________________________________________________________________________</p>
							<p style="text-transform: uppercase;"><b>Fecha:</b>_______________________________________________________________________________</p>
							<br>
		...
		<div>
			...
			<h4 style="text-align:center;"><b>LOS TESTIGOS</b></h4>
			<table class="aic-firma-testigo mt-0" style="text-align: center;width: 100%;margin-top:0;">
				<tr>
					<td>
			...
			<h4 style="text-align:center;"><b>PERSONA CON LA QUE SE ENTENDIÓ LA VISITA DOMICILIARIA</b></h4>
			<p style="text-align:center;">_______________________________________________________________________</p>
			<p style="text-align:center;"><b>Nombre y Firma</b></p>
		</div>
		<div class="page_break"></div>
		@endforeach
