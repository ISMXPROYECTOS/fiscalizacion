	...
	<body>
		...
		<div>
			...
			@if($inspeccion->comercio == null)
				<p style="margin-bottom:1%;margin-top:0;"><b>NOMBRE DEL CONTRIBUYENTE: </b>____________________________________________________________________________________</p>
				<p style="margin-bottom:1%;margin-top:0;"><b>NOMBRE COMERCIAL DEL ESTABLECIMIENTO: </b>_______________________________________________________________________</p>
				<p style="margin-bottom:1%;margin-top:0;"><b>DOMICILIO DEL ESTABLECIMIENTO: </b>_________________________________________________________________________________</p>
				...
				<p style="margin-bottom:1%;margin-top:0;"><b>NÚMERO DE PADRÓN MUNICIPAL: </b>___________________________________________________________________________________</p>
			@else
			...
			<table class="firma-orden-inspeccion">
				<tr>
					<td style="width: 40%;">
						...
						<p class="firma-encargado mbt-0" style="text-transform: uppercase;margin-bottom:0;margin-top:0;"><b>{{ $inspeccion->formavalorada->encargado->nombre }} {{ $inspeccion->formavalorada->encargado->apellidopaterno }} {{ $inspeccion->formavalorada->encargado->apellidomaterno }}</b></p>
						<p class="firma-encargado mbt-0" style="text-transform: uppercase;margin-bottom:0;margin-top:0;"><b>{{ $inspeccion->formavalorada->encargado->puesto }}</b></p>
						@endif
					</td>
					<td style="width: 60%;">
						<div style="padding: 5px;border-style: solid;border-width: 1px;">
							<p class="firma-representante mbt-0" style="text-transform: uppercase;margin-top:0;margin-bottom:0;font-size:.90em;"><b>Firma: </b>_________________________________________________________________</p>
							<p class="firma-representante mbt-0" style="text-transform: uppercase;margin-top:0;margin-bottom:0;font-size:.90em;"><b>Nombre: </b>_______________________________________________________________</p>
							<p class="firma-representante mbt-0" style="text-transform: uppercase;margin-top:0;margin-bottom:0;font-size:.90em;"><b>Fecha:</b>__________________________________________________________________</p>
							<br>
							<p class="constancia mt-0" style="margin-top:0;font-size:.90em;">Constancia de recepción de la presente Orden de Inspección. Los datos de identificación de la persona que recibe deberán quedar asentados en el Acta de Inspección que se realizará.</p>
						</div>
					</td>
				</tr>
			</table>
		...
		<div>
			<h5 style="float:right;margin-bottom:0;margin-top:0;font-size:1.2em;">FOLIO: {{ $inspeccion->folio }}</h5><br><br>
			@if($inspeccion->comercio == null)
			<p style="margin-bottom:1%;margin-top:0;"><b>NOMBRE DEL CONTRIBUYENTE: </b>___________________________________________________________________________________</p>
			<p style="margin-bottom:1%;margin-top:0;"><b>NOMBRE COMERCIAL DEL ESTABLECIMIENTO: </b>______________________________________________________________________</p>
			<p style="margin-bottom:1%;margin-top:0;"><b>DOMICILIO DEL ESTABLECIMIENTO: </b>________________________________________________________________________________</p>
			<p style="margin-bottom:1%;margin-top:0;"><b>NÚMERO DE PADRÓN MUNICIPAL: </b>_________________________________________________________________________________</p>
			@else
			<p style="margin-bottom:1%;margin-top:0;"><b>NOMBRE DEL CONTRIBUYENTE: </b>{{ $inspeccion->comercio->propietarionombre }}</p>
			<p style="margin-bottom:1%;margin-top:0;"><b>NOMBRE COMERCIAL DEL ESTABLECIMIENTO: </b>{{ $inspeccion->comercio->nombreestablecimiento }}</p>
			<p style="margin-bottom:1%;margin-top:0;"><b>DOMICILIO DEL ESTABLECIMIENTO: </b>{{ $inspeccion->comercio->domiciliofiscal }}</p>
				...
				<tr>
					<td class="ai-firma-inspector">
						<div>
							...
							<p class="mbt-0"><b>Fecha de emisión</b></p>
							<p class="mbt-0"><b>Vigencia del</b></p>
						</div>
					</td>
