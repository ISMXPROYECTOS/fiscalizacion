	...
	<body>
		...
		<div>
			...
			@if($inspeccion->comercio == null)
				<p style="margin-bottom:5px;margin-top:10px;"><b>NOMBRE DEL CONTRIBUYENTE: </b>____________________________________________________________________</p>
				<p style="margin-bottom:5px;margin-top:0;"><b>NOMBRE COMERCIAL DEL ESTABLECIMIENTO: </b>_______________________________________________________</p>
				<p style="margin-bottom:5px;margin-top:0;"><b>DOMICILIO DEL ESTABLECIMIENTO: </b>_________________________________________________________________</p>
				...
				<p style="margin-bottom:5px;margin-top:0;"><b>NÚMERO DE PADRÓN MUNICIPAL: </b>___________________________________________________________________</p>
			@else
