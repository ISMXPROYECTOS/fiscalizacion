...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			@endif
			<br>
			<p class="oc-header-datos mbt-0">Cancún, Muncipio de Benito Juárez, Quintana Roo, a @if($inspeccion->comercio == null) _____ de ________________ de ______. @else {{ $fecha_hoy }} @endif</p>
